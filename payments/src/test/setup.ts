...
process.env.STRIPE_KEY = 'sk_test_51M4U6iDq5KTwCKpvmx9vXtxl2xTkJJ0KfxIho4sqNj7frNgPZ3dib7tkk8dZYQZ4b2MvKcYKLGWwvPOwPeqWEv5M00eern90nV';
...
global.signin = (id?: string) => { //optional argument id
  // Build a JWT payload.  { id, email }
  const payload = {
    id: id || new mongoose.Types.ObjectId().toHexString(), // generate random id. // if we provide id use id otherwise generate id
    email: 'test@test.com',
  };
